  ...
  return (
    <footer className="relative border-t border-white/10">
      ...
      <div className="relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-pink-900/30 via-red-900/20 to-black" />
            ...
            <form onSubmit={handleNewsletter} className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3.5 bg-white/5 border border-white/10 rounded-xl text-white placeholder-white/40 text-sm focus:outline-none focus:border-pink-500/50 transition-all"
                />
              </div>
              <button
                type="submit"
                className="flex items-center justify-center space-x-2 px-6 py-3.5 bg-gradient-to-r from-pink-500 to-red-500 rounded-xl text-white font-semibold hover:from-pink-600 hover:to-red-600 transition-all shadow-lg shadow-pink-500/25 hover:shadow-pink-500/40 whitespace-nowrap"
              >
                <span>Subscribe</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <p className="text-white/40 text-sm leading-relaxed mb-6">
              Curated Aura-noir fashion for the modern individual. Premium quality, timeless design.
            </p>
            <div className="flex items-center space-x-3">
              ...
              <a
                ...
                className="p-2.5 rounded-xl bg-white/5 border border-white/10 text-white/50 hover:text-pink-400 hover:border-pink-500/30 hover:bg-pink-500/10 transition-all"
              >
              ...
              {['Shop All', 'New Arrivals', 'Best Sellers', 'Sale', 'Gift Cards'].map((link) => (
                <li key={link}>
                  <button
                    ...
                    className="text-sm text-white/40 hover:text-pink-400 transition-colors flex items-center group"
                  >
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center space-x-3">
                ...
                <a href="tel:+1234567890" className="text-sm text-white/40 hover:text-pink-400 transition-colors">
                  +1 (234) 567-890
                </a>
              </li>
              <li className="flex items-center space-x-3">
                <Mail className="w-4 h-4 text-pink-400 flex-shrink-0" />
                <a href="mailto:hello@luxestore.com" className="text-sm text-white/40 hover:text-pink-400 transition-colors">
                  hello@luxestore.com
                </a>
              </li>
            </ul>
