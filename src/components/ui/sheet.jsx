/**
 * JS version (converted from TS).
 * - Removed TS-only imports/types (VariantProps, React.HTMLAttributes, generics)
 * - Fixed broken variant strings (bottom/left/right)
 * - Fixed defaultVariants syntax
 */
